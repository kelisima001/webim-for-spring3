...
(function(webim) {
	...
	webim.route( {
        ...
        //room actions
		invite: path + "Webim/room/invite.html",
		join: path + "Webim/room/join.html",
		leave: path + "Webim/room/leave.html",
		block: path + "Webim/room/block.html",
		unblock: path + "Webim/room/unblock.html",
		members: path + "Webim/room/members.html",
        //notifications
